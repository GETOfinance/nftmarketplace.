...
A user can buy those NFT which someone else offered for sale in the marketplace. This will require paying the requested price (the TFUEL will be transferred to the smart contract to be claimed later on).
